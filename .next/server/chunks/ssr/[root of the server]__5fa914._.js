...
const checkAnalysisStatus = async ()=>{
    try {
        ...
        const response = await fetch(`http://127.0.0.1:8000/api/website/status`, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json'
...
const OnboardingPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        ...
        const poll = async ()=>{
            ...
            try {
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$api$2f$onboardingAPI$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["checkAnalysisStatus"])();
