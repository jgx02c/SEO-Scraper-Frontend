(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__c875ed._.js", {
...
"[project]/src/api/auth-api.ts [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/api/user-api.ts [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$auth$2d$api$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/api/auth-api.ts [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$user$2d$api$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/api/user-api.ts [client] (ecmascript)");
...
const SignInPage = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$auth$2d$api$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["signIn"])(formData.email, formData.password);
            if (!result.success || !result.token) {
                throw new Error(result.error || 'Failed to sign in');
            }
            // Check user's onboarding status
            const userState = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$user$2d$api$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["checkUserState"])();
            if (!userState) {
    ...
    const handleForgotPassword = async (e)=>{
        ...
        setIsLoading(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$auth$2d$api$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["forgotPassword"])(formData.email);
            if (!result.success) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c875ed._.js.map