(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__718779._.js", {
...
const SignUpPage = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$api$2f$authAPI$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["signUp"])(formData.email, formData.password);
            if (!result.success) {
...
_s(SignUpPage, "PfQM4ADQFBOeqzlPHgyGbZKH6SU=", false, function() {
    return [
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/src/pages/signup.tsx [client] (ecmascript)\" } [client] (ecmascript)": (function(__turbopack_context__) {
...
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_require__("[project]/src/pages/signup.tsx [client] (ecmascript)");
    }
]);
...
{
__turbopack_require__("[next]/entry/page-loader.ts { PAGE => \"[project]/src/pages/signup.tsx [client] (ecmascript)\" } [client] (ecmascript)");
}}),
}]);

//# sourceMappingURL=%5Broot%20of%20the%20server%5D__718779._.js.map